...
ALTER TABLE `tipo_investimento` ADD `taxa_administracao` DOUBLE NOT NULL AFTER `rentabilidade`;
UPDATE `tipo_investimento` SET `taxa_administracao` = '0.3' WHERE `tipo_investimento`.`id` = 2;
